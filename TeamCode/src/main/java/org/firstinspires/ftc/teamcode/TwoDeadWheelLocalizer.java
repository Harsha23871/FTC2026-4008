...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1179.3566506888471; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2056.7798615988436; // x position of the perpendicular encoder (in tick units)
    }
